...
CTC._default = {
	...
	text = {
		Deutsch = {
			...
			ttt_ctc_info_data_print = "Du bist %ctc_white%$p$%ctc_default% und es ist %ctc_white%$t$ Uhr%ctc_default% (am %ctc_white%$d$%ctc_default%), du spielst mit: {cooldudes}!",
		...
		English = {
			...
			ttt_ctc_info_data_print = "You are %ctc_white%$p$%ctc_default% and it is %ctc_white%$t$%ctc_default% (on the %ctc_white%$d$%ctc_default%), you're playing with {cooldudes}!",
